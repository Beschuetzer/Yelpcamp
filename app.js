...
const campgrounds = [
  ...
  {alt: "Multi Hued Camping", name: "Social Camping", image: "https://images.pexels.com/photos/699558/pexels-photo-699558.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500", description: "Colorfully selected tents and wonderful company abound on this camping experience.   f"},
...
app.post('/campgrounds', (req,res) =>{
  ...
  const newObj = {name:name, image:image, description: description};
